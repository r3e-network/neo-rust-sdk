...
- Live status polling (height, peers, version) with telemetry charting
...
- Activity log for background tasks with retention control
- Dark/light theme toggle, polling cadence tuning, endpoint presets (MainNet/TestNet/local)
