...
pub mod prelude {
    ...
    pub use super::enclave::{SgxEnclave, EnclaveConfig};
    pub use super::networking::{SgxNetworking, SecureChannel};
    pub use super::attestation::{RemoteAttestation, QuoteVerifier};
}